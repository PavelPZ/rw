...
export type Router = {
  ...
  getPathAndParamsForState: (state: Object) => { path?: string, params?: Object },
...
export type Options = {
  ...
  restoreScroll?: (h: History) => ScrollBehavior,
  navigators?: {
...
export type Listener = (l:HistoryLocation, a:HistoryAction) => void;
export type Listen = (l: Listener) => void;
...
export type Go = (n:number) => void;
export type CanGo = (n:number) => boolean;
...
export type Store = ReduxStore<any>;