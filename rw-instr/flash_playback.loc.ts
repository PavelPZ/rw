...
const th126: DLoc.ILocItem = {
  ...
  'cs-cz': 'PŘEHRÁVÁNÍ ANIMACE',
  'sk-sk': 'PREHRÁVANIE ANIMÁCIE',
  'ru-ru': 'FLASH PLAYBACK',
  'fr-fr': 'FLASH PLAYBACK',
  'it-it': 'FLASH PLAYBACK',
  'pl-pl': 'FLASH PLAYBACK',
  'vi-vn': 'FLASH PLAYBACK',
  'tr-tr': 'ANİMASYON OYNATMAK',
  'lt-lt': 'ANIMACIJOS ATKŪRIMAS',
  'zh-cn': 'FLASH PLAYBACK',
  'bg-bg': 'АНИМАЦИОННО ВЪЗПРОИЗВЕЖДАНЕ',
  'bs': 'FLASH PLAYBACK',
