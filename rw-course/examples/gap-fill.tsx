import React from 'react'; import { Page, DocExample, HeaderProp, DocDescr, GapFill, InlineTag, SmartElement, Offering, DropDown } from 'rw-course'; import { $l } from "rw-lib/loc"; import l from "./gap-fill-loc";
import filling_in from "rw-instr/filling_in";
export default () => /*
*********** START MARKUP HERE: */
{/*<Page title={$l('name','value')} className="app-doc">*/ }
<Page title={$l(l.Ahtmltitle)} className="app-doc" instrTitle='Instruction title' instrBody={filling_in}>
